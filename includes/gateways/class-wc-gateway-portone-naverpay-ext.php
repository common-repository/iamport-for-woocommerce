...
class WC_Gateway_Portone_NaverPayExt extends PORTONE_Payment_Gateway {
	...
	public function __construct() {
		...
		$this->method_description = __( '<b>네이버페이 정책상, 결제형-네이버페이는 사전 승인된 일부 가맹점에 한하여 제공되고 있으며 일반적으로는 "포트원(네이버페이)"를 사용해주셔야 합니다. 결제형-네이버페이 가입기준에 대해서는 포트원 고객센터(1670-5176)으로 문의 부탁드립니다.</b>', 'iamport-for-woocommerce' );
